...
Chinese recognition status, translation, continuous reading, transcript controls, glossary,
...
`LiveReaderTests` verifies live-follow intent, unseen counts, timestamp/transcript formatting, QR-code
round trips, and the immutable sharing presentation contract. Native visual, accessibility, and
